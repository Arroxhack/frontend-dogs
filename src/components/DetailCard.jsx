...
export default function DetailCard({dogId}) {
  ...
  return (
    <div className={styles.bodyDiv}>
      ...
      <h3 className={styles.temperament}>{dogId.temperament ? `Temperament: ${dogId.temperament}.` : `Unknown temperament.`}</h3>

      <div className={styles.pairDiv}>

        <h4 className={styles.weightAndHeight}>{dogId.min_weight === null ? `Min weight: unknown.` : `Min weight: ${dogId.min_weight} kg.`}</h4>

        <h4 className={styles.weightAndHeight}>-</h4>
      ...
      <div className={styles.pairDiv}>
        ...
        <h4 className={styles.weightAndHeight}>{dogId.min_life_span === null || dogId.min_life_span === false ? `Min life span: unknown.` : `Min life span: ${dogId.min_life_span} years.`}</h4>

        <h4 className={styles.weightAndHeight}>-</h4>

        <h4 className={styles.weightAndHeight}>{dogId.max_life_span === null || dogId.max_life_span === false ? `Max life span: unknown.` : `Max life span: ${dogId.max_life_span} years.`}</h4>
